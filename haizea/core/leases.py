...
####################################################################################################################################
####################################################################################################################################
#						First change (1): Add cognitive type						   #
####################################################################################################################################
####################################################################################################################################
		COGNITIVE: "Cognitive",
####################################################################################################################################
####################################################################################################################################
    ...
    def __init__(self, lease_id, submit_time, requested_resources, start, duration, 
                 deadline, preemptible, software, state, cognitive):
        """Constructs a lease.
...
##########################################################################################################################
##########################################################################################################################
#			First change (2): add attribute for cognitive type						 #
##########################################################################################################################
##########################################################################################################################
	self.cognitive = cognitive
	self.strv_counter=0
	self.queue_starttime = 0
	self.queue_endtime = 0
	self.queuingtime = 0 
...
####################################################################################################################################
####################################################################################################################################
#				First change (3): Read the cognitive type by parser						   #
####################################################################################################################################
####################################################################################################################################
            elif child.tag == "cognitive":
                start = Timestamp(Timestamp.NOW)
		cognitive = True 
####################################################################################################################################
####################################################################################################################################
    ...
    def get_type(self):
        ...
        elif self.start.requested == Timestamp.NOW and self.cognitive == False:
            return Lease.IMMEDIATE   
	elif self.start.requested == Timestamp.NOW and self.cognitive == True:
	    return Lease.COGNITIVE       
        else:
