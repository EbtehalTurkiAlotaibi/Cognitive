...
class TotalTimeprob(AccountingProbe):
    ...
    * Per-run data
	...
	# Waiting time 
	######################################
	self.total_waiting= self.total_waiting
	"""
	it was in minutes unit and it was : 
	self.total_waiting= self.total_waiting/60
	and 
        experiment.TotalTime =total_mins
	"""    
	experiment.TotalTime =self.total_waiting
	...
	DataRate = DataRate *100
        ...
        experiment.Throughput_after_2_hour = self.cntr 
