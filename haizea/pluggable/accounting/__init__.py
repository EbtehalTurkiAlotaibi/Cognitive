...
probe_class_mappings = {             "ar": "haizea.pluggable.accounting.leases.ARProbe",
			...
			"AverageWaitingTime" : "haizea.pluggable.accounting.leases.TotalTimeprob",
			"TotalTime": "haizea.pluggable.accounting.leases.TotalTimeprob",
			"Throughput_after_1_hour": "haizea.pluggable.accounting.leases.TotalTimeprob",
			"Throughput_after_2_hour": "haizea.pluggable.accounting.leases.TotalTimeprob",
			"DataRate" : "haizea.pluggable.accounting.leases.TotalTimeprob",
                        }
