    ...
    def run(self):
        ...
        try:
            ...
            for e in db.query(Experiment).order_by("-id").all():
		     ...
		     "AverageWaitingTime" : e.AverageWaitingTime,
		      "Throughput_after_1_hour" : e.Throughput_after_1_hour,
		      "Throughput_after_2_hour" : e.Throughput_after_2_hour,		
            ...
            fields = [("id","ID", 3),
                  ...
                  ("AverageWaitingTime","Average Waiting Time (mins)", 27) ,
("Throughput_after_1_hour", "Throughput (job/1 h)", 20),   
("Throughput_after_2_hour", "Throughput (job/2 h)", 20),   
		   ("TotalTime","Total Time (mins)", 10) , 
		   ("DataRate" , "Jobs Completion Rate(%)" , 2 ) 
...
class haizea_experiments_statistics_list(Command):
    ...
    def run(self):
        ...
        try:
		    ...
		    {"name":"Average waiting time", "value":exp.AverageWaitingTime},
		    {"name":"Total Turaround Time", "value":exp.TotalTime},
]
                ...
                for e in lease_statistics:
                    d = {"id":e.lease_id, "waiting":e.waiting_time}
                    values.append(d)
